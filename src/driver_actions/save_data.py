...
class SavingData :
    ...
    def save_data (self):
        ...
        for web_element in self.list_web_element:
            ...
            l_reaction.append([data["post" + str(k)]['react']['J’aime '],data["post" + str(k)]['react']['J’adore ' ],data["post" + str(k)]['react']['Haha'],data["post" + str(k)]['react']['Grrr' ]])
        ...
        with open('LBGplc.json', 'w', encoding='utf-8') as json_file:
